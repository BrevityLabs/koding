...
function getGoing(aggrType){
	...
	formData = {
		'Sale': 
			{'price'	: $('select[name=Sale\\[price\\]]').val(),
			 'soldonLow': $('select[name=soldonLow]').val(),
			 'soldonHigh': $('select[name=soldonHigh]').val(),
		...
		'aggr': $('input[name=aggr]').val(),
	 };

	console.log(formData['Sale']);
