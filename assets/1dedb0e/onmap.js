...
$(document).ready(function() {
	...
	var aggregate = $("input:radio[name=aggr]:checked").val();
	getGoing(aggregate);
...
//		.text(function(d){ return d.countOfSale;});
		...
		svg.selectAll("circle")
			.data(jsonpipe)
			.enter().append("circle")
				.attr("cx", 200) //function(d) { return projection([d.lng, d.lat])[0];})
				.attr("cy", 200) //function(d) { return projection([d.lng, d.lat])[1];})
